    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        @elseif(auth()->user()->isSeeker())
                            ...
                            <x-nav-link :href="route('jobs.saved')" :active="request()->routeIs('jobs.saved')">
                                {{ __('Saved Jobs') }}
                            </x-nav-link>
                        @endif
                    @endauth
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-4">
                ...
                @auth
                <div class="relative">
                    <a href="#" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 relative p-1 transition-all">
