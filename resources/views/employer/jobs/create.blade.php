    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg ring-1 ring-gray-200 dark:ring-gray-700">
                <form action="{{ route('employer.jobs.store') }}" method="POST" class="p-8 space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input id="location" name="location" type="text" class="mt-1 block w-full" :value="old('location')" required placeholder="e.g. New York, Remote" />
                    ...
                    <div>
                        ...
                        <x-text-input id="salary_range" name="salary_range" type="text" class="mt-1 block w-full" :value="old('salary_range')" placeholder="e.g. $50k - $80k" />
